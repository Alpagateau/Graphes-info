...
Donc si G est cyclique, alors il existe un cycle ne passant pas par x. Donc le sous-graphe obtenu en retirant x conserve ce cycle. D'où la conservation de la non acyclicité par \varPsi{}.

De plus, retirer un sommet et une arête ne peut pas créer de cycle donc \varPsi{} conserve aussi l'acyclicité.
